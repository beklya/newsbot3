"""Lightweight counters/gauges for the Predictor service.

Same pattern as src/services/enricher/metrics.py — additive counters,
rolling latency window, snapshot dict for heartbeats.
"""
